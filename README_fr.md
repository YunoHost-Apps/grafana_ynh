...
**Version incluse :** 9.1.7~ynh1 *(:warning: Il s'agit de la branche `ci-auto-update-v9.1.7`. La [branche `master`](https://github.com/YunoHost-Apps/grafana_ynh/tree/master) utilisée dans le catalogue est actuellement en 9.1.6\~ynh1.)*
